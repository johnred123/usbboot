...
static int handle_help(void)
{
	...
	" ndump      save NAND flash to file"
	" cmd        (not impliment)"
	" msg        show message"
	" gpior      show gpio"
	" mread      read SDRAM image and show"
	" mdump      save SDRAM image to file"
	" exec       load file data to SDRAM and run\n"
...
extern int sdram_loadexec(void);
