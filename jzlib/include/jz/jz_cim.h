...
#endif /* defined(__JZ4750__) || defined(__JZ4755__) */
...
#endif /* defined(__JZ4740__) || defined(__JZ4750__) */
...
#define	CIM_CTRL_RXF_TRIG_MASK  (0xf << CIM_CTRL_RXF_TRIG_BIT) /* trigger value = (n+1)*burt_type *//
#endif
