...
void gpio_init_4750(void)
{
	...
	int jz4725b_pre_check = (unsigned int) ( * (volatile unsigned int *) 0xB00F0000 );
    ...
    if(jz4725b_pre_check & 0x80000000) /* jz4725b */
    {
        REG_CPM_CLKGR = 0x0;
        __gpio_as_sdram_16bit();
        gpio_as_uart0_4725b();
        gpio_as_nand_8bit_4725b(1);
    }
    else if (processor_id == PROID_4750)  /* jz4750 */
	{
