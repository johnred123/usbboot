...
static inline void gpio_as_uart0_4755()
{
...
static inline void gpio_as_uart1_4755()
{
...
static inline void gpio_as_uart0_4725b()
{
...
#define gpio_as_nand_8bit_4725b(n)						\
do {		              						\
	/* 32/16-bit data bus */					\
...
#define __gpio_as_nand_8bit_4725b(n)					\
do {		              						\
	/* 32/16-bit data bus */					\
	REG_GPIO_PXFUNS(0) = 0x000000ff; /* D0~D7 */			\
	REG_GPIO_PXSELC(0) = 0x000000ff;				\
